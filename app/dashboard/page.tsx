  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-400 mt-1 text-sm capitalize">{dateStr}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {visibleCards.map(card => (
          <a
            key={card.href}
            href={card.href}
            className="group relative bg-slate-800 border border-slate-700 rounded-2xl p-6
                       hover:border-slate-600 hover:bg-slate-750 transition overflow-hidden"
          >
            {/* Gradient nền */}
      ...
      {/* Thông tin nhanh */}
      <div className="mt-8 bg-slate-800/50 border border-slate-700/50 rounded-2xl p-5">
